...
@Composable
fun CreateScreen(navController:NavController,viewModel: PlantViewModel = hiltViewModel() ) {
                ...
                ExposedDropdownMenu(
                    ...
                    listItems.forEach { selectedOption ->
                        ...
                        DropdownMenuItem(onClick = {
                            ...
                            category_id = listItems.indexOf(selectedOption).toString()
            ...
            Button(
                ...
                onClick = {
                   viewModel.addPlant(category_id,selectedImage.toString(), name,
                       selectedItem.toString(),room_location)
